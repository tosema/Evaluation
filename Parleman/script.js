...
// آدرس پایه اصلاح شده برای نمایش تصاویر گوگل درایو (استفاده از روش /open?id=)
const DRIVE_BASE_URL = 'https://drive.google.com/open?id='; 
    ...
    return `
        <div class="member-card">
            <img 
                ...
                alt="تصویر ${name}" 
                loading="lazy" 
                onerror="this.onerror=null;this.src='https://via.placeholder.com/250x250.png?text=Access+Denied';"
            >
